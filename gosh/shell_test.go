...
import (
	...
	lib "fuchsia.googlesource.com/jiri/gosh/internal/gosh_example_lib"
)
...
const (
	helloWorldPkg = "fuchsia.googlesource.com/jiri/gosh/internal/hello_world"
...
func TestCmd(t *testing.T) {
	...
	binPath := gosh.BuildGoPkg(sh, binDir, "fuchsia.googlesource.com/jiri/gosh/internal/gosh_example_server")
	c := sh.Cmd(binPath)
	c.Start()
	...
	// Run client.
	binPath = gosh.BuildGoPkg(sh, binDir, "fuchsia.googlesource.com/jiri/gosh/internal/gosh_example_client")
